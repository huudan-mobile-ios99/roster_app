...
class _updateUserState extends State<updateUser> {
  ...
  List<String> list_group = ['IT Technical', 'Security'];
  List<String> list_gender = ['Male', 'Female'];
  List<String> list_role = ['User', 'Manager'];
  String? valueGender, valueRole, valueGroup, valueDatePicker;
                ...
                children: [
                  Row(
                    ...
                    children: [
                      ...
                      textCustom(MyString.updateUser, 24),
                    ],
                  ),
                  const SizedBox(
                    height: 40,
                                ...
                                widget: ListView.builder(
                                  ...
                                  itemBuilder: (context, index) {
                                    return Card(
                                      ...
                                      onTap: () {
                                        setState(() {
                                          valueGroup = list_group[index];
                                        });
                                        Navigator.of(context).pop();
                                      },
                                      title: Text(
                                          '${index + 1}.  ${list_group[index]}'),
                                    ));
                                  },
                                ),
                  ...
                  myButton(
                      ...
                      text: MyString.updaetUserButton,
                      width: width,
